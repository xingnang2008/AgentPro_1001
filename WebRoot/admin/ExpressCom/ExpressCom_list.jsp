		...
		$('#dg').datagrid({    
			   ...
			   loadMsg:'请等待...',
				...
				toolbar: [{
					...
					handler: function(){
						$("#win").window({
							...
							width:'650',
							height:'80%',
							content:'<iframe src="ExpressCom_saveInput.jsp" frameborder="0" width="100%" height="100%"> </iframe>'
						});
					...
					},
					{
						...
						if(rows.length !=1){
							...
							$("#win").window({
								...
								width:'1025',
								height:'645',
								content:'<iframe title="" src="ExpressCom_updateInput.jsp" frameborder="0" width="100%" height="100%"/>'
							});
					}}},
					{
						iconCls: 'icon-remove',
						...
						if(rows.length ==0){
							...
							$.messager.confirm("删除确认对话框","是否要删除选中的记录",function(r){
								if(r){
									...
									//发送ajax请求
									$.post("ExpressCom-deleteByIds.action",{ids:ids},function(result){
										if(result =="true"){
											$.messager.show({
												title:'删除成功',
												msg:'删除成功',
			    ...
			    columns:[[ 			      
					        ...
					        {field:'expressCom',title:'公司名',align:'center',width:150},
